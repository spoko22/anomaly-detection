...
execution_version = "1.4.1-RF-INVESTIGATION"
...
PCA_TURNED_ON = False
TECHNICAL_FEATURES_FE_TURNED_ON = False
CROSSVALIDATION_ITERATIONS = 4
FS_LOOP_START = 3
FS_LOOP_END = 7
...
fixed_features = {
    "scenario_1.binetflow": ['Sport', 'Dport', 'Dur', 'SrcBytes', 'TotBytes', 'TotPkts', 'State', 'Proto', 'Dir'],
    "scenario_2.binetflow": [ 'TotBytes', 'SrcBytes', 'Dur', 'Dport', 'State', 'TotPkts', 'Sport', 'Proto', 'Dir'],
    "scenario_6.binetflow": ['Dport', 'TotBytes', 'SrcBytes', 'Dur', 'State', 'Proto', 'TotPkts', 'Sport', 'Dir'],
    "scenario_8.binetflow": ['Dport', 'TotBytes', 'SrcBytes', 'State', 'Dur', 'Sport', 'TotPkts', 'Proto', 'Dir'],
    "scenario_9.binetflow": ['TotBytes', 'SrcBytes', 'Dur', 'Dport', 'Sport', 'State', 'TotPkts', 'Proto', 'Dir']
}
...
def perform_osvm(filename):
    ...
    for features_number in range(FS_LOOP_START, FS_LOOP_END):
        X = original_dataset[:]
        engineered_features = []
        ...
        for i in range(1, CROSSVALIDATION_ITERATIONS+1):
            logger.log('Loop ' + i.__str__() + "/" + CROSSVALIDATION_ITERATIONS.__str__())
            ...
            if features_number >= f_set.__len__():
                features_number = f_set.__len__()-1
                logger.log("WARNING! Features number exceeds f_set!")

            chosen_features = f_set[:features_number]
