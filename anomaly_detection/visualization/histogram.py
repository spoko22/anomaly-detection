...
fig, (normal_ax_0, normal_ax_1,normal_ax_2,normal_ax_3,normal_ax_4,normal_ax_5, normal_ax_6) = plt.subplots(nrows=7, figsize=(12,24))
# normal = normal[(normal < 4000)]

sns.distplot(normal, kde=False, color="b", ax=normal_ax_0, bins=100)
sns.distplot((normal[(normal < 100000)].dropna(axis=1, how='all')), kde=False, color="b", ax=normal_ax_1, bins=100, hist_kws={"range": [0, 100000]})
sns.distplot((normal[(normal < 4000)].dropna(axis=1, how='all')), kde=False, color="b", ax=normal_ax_2, bins=50, hist_kws={"range": [0, 4000]})
sns.distplot((normal[(normal > 4000) & (normal < 10000)].dropna(axis=1, how='all')), kde=False, color="b", ax=normal_ax_3, bins=50, hist_kws={"range": [4000, 10000]})
sns.distplot((normal[(normal < 750)].dropna(axis=1, how='all')), kde=False, color="b", ax=normal_ax_4, bins=50, hist_kws={"range": [0, 750]})
sns.distplot((normal[(normal < 100) & (normal > 50)].dropna(axis=1, how='all')), kde=False, color="b", ax=normal_ax_5, bins=50, hist_kws={"range": [50, 100]})
sns.distplot((normal[(normal > 1000) & (normal < 2200)].dropna(axis=1, how='all')), kde=False, color="b", ax=normal_ax_6, bins=50, hist_kws={"range": [1000, 2200]})
...
normal_ax_6.set_xlabel("SrcBytes")
normal_ax_6.set_ylabel("Frequency")
